function LowPolyPlanet() {
  ...
  let scene, camera, cameraCtrl, width, height, planet, cloud;
  ...
  function Initialize() {
    ...
    cameraCtrl.maxDistance = 450;    
    cameraCtrl.minDistance = 300;
  ...
  function InitializeScene() {      
    ...
    var PointsList = []
    let geometry, material, mesh, PointMaterial, pointCloud, ArePoints;       
